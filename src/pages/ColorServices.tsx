            ...
            <section id="colorServiceListWrapper">
                <div id="colorServiceListContainer">
                    ...
                    <div id="colorServiceListLinksContainer">
                        <a href="#" className="colorServiceListLink">Gray Blending</a>
                        <a href="#" className="colorServiceListLink">Balayage</a>
                        <a href="#" className="colorServiceListLink">All Over Color</a>
                        <a href="#" className="colorServiceListLink">Express Color</a>
                        <a href="#" className="colorServiceListLink">Glaze</a>
                        <a href="#" className="colorServiceListLink">Vivid Color</a>
                        <a href="#" className="colorServiceListLink">Corrective</a>
                    </div>
